...
import { MessageSquare, Calendar, User, LogOut, Menu, X, Plane, BookmarkCheck, ChevronDown } from 'lucide-react';
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="hidden sm:block text-[#0066FF]">Travel Planner GPT</span>
              </div>
            </div>
              ...
              {isDropdownOpen && (
                <div className="absolute right-0 top-full mt-2 w-48 rounded-xl bg-white border shadow-lg z-[100] py-1 animate-in fade-in-0 zoom-in-95">
                  ...
                  <button
                    onClick={() => {
                      setIsDropdownOpen(false);
                      activeTab === 'itineraries' ? onTabChange('profile') : onTabChange('itineraries');
                    }}
                    className="w-full flex items-center gap-2 px-4 py-2 hover:bg-muted rounded-lg cursor-pointer text-left"
                  >
                    ...
                    {activeTab === 'itineraries' ? 'Hồ sơ cá nhân' : 'Lịch trình đã lưu'}
                  </button>
