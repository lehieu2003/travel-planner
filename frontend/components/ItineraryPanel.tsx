import { MapPin, Clock, Star, Utensils, Mountain, Coffee, X, Bookmark, Share2, Map, DollarSign, Navigation } from 'lucide-react';
...
export function ItineraryPanel({ itineraryData, onClose, onSaveSuccess }: ItineraryPanelProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast.error(error instanceof Error ? error.message : 'Không thể lưu lịch trình');
    }
  };
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-6">
        ...
        <div className="bg-gradient-to-br from-[#0066FF]/10 to-[#00C29A]/10 rounded-2xl p-4">
          <h2 className="mb-3 text-lg font-semibold">{itineraryData.destination}</h2>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <div className="bg-white rounded-lg px-3 py-2 shadow-sm border border-border/50 flex items-center gap-2 flex-1 min-w-[140px]">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[10px] text-muted-foreground leading-tight">Thời lượng</p>
            ...
            <div className="bg-white rounded-lg px-3 py-2 shadow-sm border border-border/50 flex items-center gap-2 flex-1 min-w-[140px]">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[10px] text-muted-foreground leading-tight">Ngân sách</p>
                <p className="text-sm font-semibold text-foreground truncate leading-tight">
            ...
            <div className="bg-white rounded-2xl border border-border overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-4">
                ...
                <p className="text-[#0066FF] mb-3">
                  {itineraryData.hotel.price} {itineraryData.hotel.price.includes('VNĐ') ? '' : 'VNĐ'}
                </p>
