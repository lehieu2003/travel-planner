...
import { Plus, MessageCircle, Edit2, Trash2, Menu, X } from 'lucide-react';
            ...
            {conversations.map((conversation) => (
              <motion.div
                ...
                className={`group relative rounded-xl p-3 cursor-pointer transition-all duration-200 ${
                  activeConversationId === conversation.id
                    ...
                    : 'bg-white hover:bg-muted border border-transparent'
                }`}
              ...
              >
                  ...
                  <div className="flex-1 min-w-0">
                    {editingId === conversation.id ? (
                      <input
                        ...
                        className="w-full px-2 py-1 rounded border border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
                        autoFocus
                ...
                {hoveredId === conversation.id && editingId !== conversation.id && (
                  <div className="absolute right-2 top-3 flex gap-1 bg-white rounded-lg shadow-md p-1">
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
